const APIKEY = "9b5eda17bc506f0bba941c6c11985152";
populateHistory();
...
function getFiveDayForecast(cityLookUp) {
    let weatherData = getWeatherData();
    let forecastURL = `https://api.openweathermap.org/data/2.5/forecast?q=${cityLookUp}&units=imperial&appid=9b5eda17bc506f0bba941c6c11985152`;
...
// Storing the forecast of the city to local storage.
